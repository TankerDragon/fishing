...
(function () {
  ...
  function hb(h) {
    if (h._menuButton)
      h.exportEnabled
        ? (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText))
        : ua(h._menuButton);
  ...
  function va(h, n, v) {
    n.getAttribute("state") ||
      ...
      (n.style.border = "none"),
      U(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ...
            : "center" === this.horizontalAlign &&
              ((x = h.y1 + (h.height / 2 - M.height / 2)), (w = h.x1 + (h.width / 2 - M.width / 2)), (H = "center"), (this.width = M.width), (this.height = M.height)),
          (N = "center"));
      J.x = w;
      J.y = x;
      J.angle = F;
  ...
  x = Pa.Chart = (function () {
    ...
    function x(a, d, c, b, e, f, l, t, B, k) {
      ...
      B && 0 < l.thickness
        ...
        : 0 < l.thickness && (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
      a.stroke();
      a.restore();
    }
    function F(a, d) {
    ...
    function T(a, d, c, b) {
      ...
      "string" === typeof this.spacing
        ? ((this.spacing = parseFloat(this.spacing)), (this.spacing = isNaN(this.spacing) ? 8 : (10 < this.spacing ? 10 : this.spacing) + "%"))
    ...
    n.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        ...
        this.zoomEnabled ||
          this.panEnabled ||
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? ((this.panEnabled = !0), (this.zoomEnabled = !1)) : ((this.zoomEnabled = !0), (this.panEnabled = !1)),
        ...
        for (var c = 0; c < this.options.data.length; c++)
          if ((a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type))) {
            ...
            null === b.color
              ...
              : (b._colorSet = [b.color]);
            null === b.markerSize &&
              ((("line" === b.type || "stepLine" === b.type || "spline" === b.type || 0 <= b.type.toLowerCase().indexOf("area")) && b.dataPoints && b.dataPoints.length < this.width / 16) ||
                "scatter" === b.type) &&
              (b.markerSize = 8);
    ...
    n.prototype.setLayout = function () {
      ...
      for (d = 0; d < this._axes.length; d++)
        if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
          w
            ? ((this._breaksCanvas = ta(this.width, this.height, !0)), (this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")))
      ...
      ("normal" !== this.plotInfo.axisPlacement && "xySwapped" !== this.plotInfo.axisPlacement) ||
        E.setLayout(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
    };
    n.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
          ...
          t.targetCanvas = null;
          this.animatedRender &&
            ((t.targetCanvas = ta(this.width, this.height)), (t.targetCanvasCtx = t.targetCanvas.getContext("2d")), (e = t.targetCanvasCtx.miterLimit), (t.targetCanvasCtx.miterLimit = 3));
          "line" === t.type
            ? (B = this.renderLine(t))
            : "stepLine" === t.type
          ...
          for (B = 0; B < t.dataPoints.length; B++) {
            ...
            if (b < q && !k) null !== e && (p = b);
              ...
              null === e
                ...
                : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e));
            }
          }
    ...
    n.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        a.axisY.logarithmic
          ? ((d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05))),
    ...
    n.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c)
            for (
              var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, t = 0, B = 0;
          ...
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++)
              (b = a(
                f[t].start,
                f[t].end,
                this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min,
    ...
    n.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        (d && "line" !== b[c].dataSeries.type && "stepLine" !== b[c].dataSeries.type && "area" !== b[c].dataSeries.type && "stepArea" !== b[c].dataSeries.type) ||
                ...
                if (((b = this._events[f]), (e = b.bounds), d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2)) {
                  ...
                  "mousedown" === c && !0 === b.capture
                    ? ((n.capturedEventParam = b),
                      this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1))
                    : "mouseup" === c &&
                      (b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                  break;
                } else b = null;
        ...
        if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
          ...
          for (var t = 0; t < this.axisX.length; t++)
            this.axisX[t].crosshair &&
              ...
              (this.axisX[t].crosshair.hide(), this.axisX[t].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX[t].options }, this.axisX[t].crosshair));
          ...
          for (t = 0; t < this.axisY.length; t++)
            this.axisY[t].crosshair &&
              ...
              (this.axisY[t].crosshair.hide(), this.axisY[t].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[t].options }, this.axisY[t].crosshair));
          ...
          if (
            ...
            !(
              ...
              (!(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                ((p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3)) || (!p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)))) ||
              q < p.minimum ||
              g > p.maximum
            ))
          )
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          ...
          C = null;
        if (0 <= m.dataSeries.type.indexOf("stacked") || "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) z = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
        if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter)
          C = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: z.total, percent: z.percent };
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== z
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b), g < e && ((g = "auto" === z ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t), (x = g + k > m.point.y)))
                  : ((g = m.point.y + r / 2 + t + b), g > f - k && ((g = "auto" === z ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k), (x = g < m.point.y))))
            ...
            0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter")
              ...
              "inside" !== z
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > v
                    ? ((q = m.point.x - ("horizontal" === C ? B : B - r / 2) - l - b), q < e && ((q = "auto" === z ? Math.max(m.point.x, e) + l : e + l), (x = q + B > m.point.x)))
                    : ((q = m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b),
                      q > f - B - l - b && ((q = "auto" === z ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l), (x = q < m.point.x))))
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]), (h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)), (m.dataSeries.indexLabelBackgroundColor = s(h) ? (w ? "transparent" : null) : h);
      return d;
    };
                ...
                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), (C = !0);
                  ...
                  n || C
                    ...
                    : (c.lineTo(y, D),
                      ...
                      c.lineTo(y, s),
                      w && b.lineTo(y, s),
                      0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                  l = { x: y, y: s };
                  u < m.length - 1 &&
                    (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                  ...
                  if (0 < m[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, y, s, c)),
                      f.push(D),
                      (A = P(A)),
                      w && f.push({ x: y, y: s, ctx: b, type: D.type, size: D.size, color: A, borderColor: A, borderThickness: D.borderThickness });
                  (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
              ...
              if (((u = m[n].getTime ? m[n].x.getTime() : m[n].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))))
                if ("number" !== typeof m[n].y)
                  ...
                  n < m.length - 1 &&
                    ...
                    b.setLineDash &&
                      (m[n].lineDashType ? ((p = m[n].lineDashType), (s[s.length - 1].newLineDashArray = N(p, k.lineThickness))) : ((p = k.lineDashType), (s[s.length - 1].newLineDashArray = g))));
          ...
          if (0 < r.length)
            for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
              if ((r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                ...
                l = a.axisX.reversed
                  ? (l + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + m) * p) << 0
                  : (l - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + m) * p) << 0;
    ...
    n.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 * ((e.width * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range))) / a.plotType.plotUnits.length)) << 0;
            ...
            for (var s = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                  ...
                  f[b] = A + (D - p);
                } else (A = "undefined" !== typeof l[b] ? l[b] : 0), (D = p + A), (p = q + A), a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), (l[b] = A + (D - p));
                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                ea(c, z, p, C, D, b, 0, null, s && 0 <= u[k].y, 0 > u[k].y && s, !1, !1, n.fillOpacity);
                b = n.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: C, y2: D };
    ...
    n.prototype.renderBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        p = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 * ((e.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range))) / a.plotType.totalDataSeries)) << 0;
        this.dataPointMaxWidth && f > m && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
        !this.dataPointMaxWidth && this.dataPointMinWidth && m < f && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        p < f && (p = f);
        p > m && (p = m);
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if ((r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                ...
                t = a.axisX.reversed
                  ? (t + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + m) * p) << 0
                  : (t - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + m) * p) << 0;
    ...
    n.prototype.renderStackedBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 * ((e.height * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range))) / a.plotType.plotUnits.length)) << 0;
            ...
            for (k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = D = a.axisY.convertValueToPixel(B[b]));
            ...
            for (k = 0; k < u.length; k++)
              if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                  ...
                  (B[b] = z + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = z = a.axisY.convertValueToPixel(B[b]));
                ...
                b = n.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: C, x2: m, y2: D };
                b = P(b);
    ...
    n.prototype.renderArea = function (a) {
      ...
      function b() {
        D &&
          ...
          a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (C = z) : 0 > a.axisY.viewportMaximum ? (C = t.y1) : 0 < a.axisY.viewportMinimum && (C = z),
          f.lineTo(n, C),
          f.lineTo(D.x, C),
          f.closePath(),
              ...
              if (((s = r[h].x.getTime ? r[h].x.getTime() : r[h].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))))
                if ("number" !== typeof r[h].y) g.connectNullData || ja || d || b(), (ja = !0);
                  ...
                  0 !== r[h].markerSize &&
                    ...
                    B.push(s),
                    (Y = P(Y)),
                    w && B.push({ x: n, y: u, ctx: l, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                  (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: n, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: A });
                }
            b();
            $.drawMarkers(B);
          }
              ...
              if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))))
                if ("number" !== typeof p[q].y)
                  0 < q &&
                    !r &&
                    (m.connectNullData
                      ? b.setLineDash && 0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = x), (A = m.nullDataLineDashType))
                      : (d(), (s = []))),
                    (r = !0);
                else {
                  ...
                  q < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[q].lineDashType ? ((A = p[q].lineDashType), (s[s.length - 1].newLineDashArray = N(A, m.lineThickness))) : ((A = m.lineDashType), (s[s.length - 1].newLineDashArray = E))));
                  ...
                  (p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: m, point: { x: g, y: r }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: z });
                  r = !1;
                }
            d();
            $.drawMarkers(l);
                ...
                "number" !== typeof r[h].y
                  ...
                  : ((n = a.axisX.convertValueToPixel(s)),
                    ...
                    0 !== r[h].markerSize &&
                      ...
                      B.push(Y),
                      (s = P(s)),
                      w && B.push({ x: n, y: u, ctx: l, type: Y.type, size: Y.size, color: s, borderColor: s, borderThickness: Y.borderThickness })),
                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                      this._indexLabels.push({ chartType: "stepArea", dataPoint: r[h], dataSeries: g, point: { x: n, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: A }));
              }
            b();
            $.drawMarkers(B);
          }
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))))
                if ("number" !== typeof fa.y) A.connectNullData || Y || y || d(), (Y = !0);
                  ...
                  y || Y
                    ? (!y && A.connectNullData
                        ? (b.setLineDash &&
                            (A.options.nullDataLineDashType || (z === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                            ((y = k.pop()), (z = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(z), k.push(y), (z = A.nullDataLineDashType), b.setLineDash(aa)),
                          b.lineTo(g, r),
                          w && s.lineTo(g, r))
                  ...
                  q < v.length - 1 &&
                    ...
                    (Q = v[q].lineColor || x),
                    (b.strokeStyle = Q),
                    b.setLineDash && (v[q].lineDashType ? ((z = v[q].lineDashType), b.setLineDash(N(z, A.lineThickness))) : ((z = A.lineDashType), b.setLineDash(E))));
                  ...
                  (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter || A.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: A, point: { x: g, y: r }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, r);
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))))
                if ("number" !== typeof fa.y) A.connectNullData || Y || s || d(), (Y = !0);
                  ...
                  s || Y
                    ? (!s && A.connectNullData
                        ? (b.setLineDash &&
                            ...
                            ((s = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(n.x, n.y), k.push(u), k.push(s), (u = A.nullDataLineDashType), b.setLineDash(aa)),
                          b.lineTo(g, r),
                          w && z.lineTo(g, r))
                        : (b.beginPath(), b.moveTo(g, r), w && (z.beginPath(), z.moveTo(g, r))),
                      (Y = s = !1))
                    : (b.lineTo(g, r), w && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && z.moveTo(g, r), k.push({ x: g, y: y - ba })));
                  n = { x: g, y: r };
                  q < x.length - 1 &&
                    ...
                    (Q = x[q].lineColor || E),
                    (b.strokeStyle = Q),
                    b.setLineDash && (x[q].lineDashType ? ((u = x[q].lineDashType), b.setLineDash(N(u, A.lineThickness))) : ((u = A.lineDashType), b.setLineDash(F))));
                  if (0 <= A.dataPointIndexes[f]) {
                  ...
                  (fa.indexLabel || A.indexLabel || fa.indexLabelFormatter || A.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: A, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, r);
              ...
              if (
                ...
                "candlestick" === u.type
                  ? (c.moveTo(h - x, m),
                    ...
                    c.lineTo(h - x, p),
                    c.stroke(),
                    ea(c, C, Math.min(k, q), D, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, A, e, z, z, !1, !1, u.fillOpacity),
                    w &&
                      ((e = P(E)),
                      (b.strokeStyle = e),
                      b.moveTo(h - x, m),
            ...
            for (var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < z.length; l++)
              if (
                ...
                w &&
                  ...
                  0 < aa &&
                    (b.beginPath(), (b.lineWidth = aa), b.moveTo(t + Y / 2, p - fa), b.lineTo(t - Y / 2, p - fa), b.stroke(), b.moveTo(t + Y / 2, h + fa), b.lineTo(t - Y / 2, h + fa), b.stroke()));
                (z[l].indexLabel || y.indexLabel || z[l].indexLabelFormatter || y.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: y.type,
                    dataPoint: z[l],
                    dataSeries: y,
            ...
            for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
              if (
                ...
                var n = a.axisX.reversed
                    ? (b + (a.plotType.totalDataSeries * k) / 2 - (a.previousDataSeriesCount + m) * k) << 0
                    : (b - (a.plotType.totalDataSeries * k) / 2 + (a.previousDataSeriesCount + m) * k) << 0,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          var z = a.dataSeriesIndexes[y],
            C = this.data[z],
            D = C.dataPoints,
            A = s(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/gi) && C._linkedSeries.visible ? !0 : !1,
            E = 0;
          if (A)
          ...
          u = this.options.dataPointWidth
            ? this.dataPointWidth
            : (0.9 * (((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range))) / (A ? v : 1))) << 0;
          ...
          if (0 < D.length)
            for (var F = C._colorSet, t = 0; t < D.length; t++) {
              ...
              if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                ...
                b ? (p = ja) : (g = ja);
                b
                  ? ((q = a.axisX.reversed ? (k + ((A ? v : 1) * u) / 2 - (A ? E - 1 : 0) * u) << 0 : (k - ((A ? v : 1) * u) / 2 + (A ? E - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed ? (h + ((A ? v : 1) * u) / 2 - (A ? E - 1 : 0) * u) << 0 : (h - ((A ? v : 1) * u) / 2 + (A ? E - 1 : 0) * u) << 0),
    ...
    n.prototype.renderRangeBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        m = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.9 * ((e.height * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range))) / a.plotType.totalDataSeries)) << 0;
        this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l));
        !this.dataPointMaxWidth && this.dataPointMinWidth && l < f && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        m < f && (m = f);
        m > l && (m = l);
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                h = a.axisX.reversed
                  ? (h + (a.plotType.totalDataSeries * m) / 2 - (a.previousDataSeriesCount + p) * m) << 0
                  : (h - (a.plotType.totalDataSeries * m) / 2 + (a.previousDataSeriesCount + p) * m) << 0;
              ...
              if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))))
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || Q
                    ? (m.connectNullData && !q
                        ? (b.setLineDash &&
                            (m.options.nullDataLineDashType || (A === m.lineDashType && m.lineDashType !== m.nullDataLineDashType)) &&
                            ((h[h.length - 1].newLineDashArray = E), (A = m.nullDataLineDashType), b.setLineDash(x)),
                          b.lineTo(r, n),
                          w && e.lineTo(r, n),
                          h.push({ x: r, y1: n, y2: s }))
                  ...
                  g < p.length - 1 &&
                    ...
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((A = p[g].lineDashType), (h[h.length - 1].newLineDashArray = N(A, m.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                        : ((A = m.lineDashType), (h[h.length - 1].newLineDashArray = E), b.setLineDash(E))));
              ...
              if (((q = m[p].x.getTime ? m[p].x.getTime() : m[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                  ...
                  p < m.length - 1 &&
                    ...
                    b.setLineDash &&
                      (m[p].lineDashType ? ((C = m[p].lineDashType), (s[s.length - 1].newLineDashArray = N(C, k.lineThickness))) : ((C = k.lineDashType), (s[s.length - 1].newLineDashArray = D))));
                  ...
                  0 < p &&
                    !g &&
                    (k.connectNullData
                      ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = A), (C = k.nullDataLineDashType))
                      : (d(D, y), (s = []), (x = []))),
                    (g = !0);
            d(D, y);
            $.drawMarkers(f);
    ...
    n.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        q = this.options.dataPointWidth
          ? this.dataPointWidth
          : (0.6 * ((f.width * (a.axisX.logarithmic ? Math.log(q) / Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range))) / a.plotType.totalDataSeries)) << 0;
          ...
          if (0 < v.length)
            for (var z = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, x = null, A = null, l = 0; l < v.length; l++)
              if ((v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), "number" !== typeof v[l].y)) {
                ...
                h = a.axisX.reversed
                  ? (h + (a.plotType.totalDataSeries * q) / 2 - (a.previousDataSeriesCount + g) * q) << 0
                  : (h - (a.plotType.totalDataSeries * q) / 2 + (a.previousDataSeriesCount + g) * q) << 0;
                ...
                0 < l &&
                  ...
                  c.lineTo(Q, aa - y),
                  0 < u && c.stroke(),
                  w && (b.beginPath(), b.moveTo(x, A - y), b.lineTo(Q, aa - y), 0 < u && b.stroke()));
                C = !1;
                x = F;
                A = 0 < v[l].y ? n : k;
    ...
    var ha = function (a, d, c, b, e, f, l, h, n) {
      if (!(0 > c)) {
        ...
        "pie" === e
          ...
          : "doughnut" === e &&
            (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= n && a.arc(d.x, d.y, n * c, l, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
        a.globalAlpha = 1;
        a.restore();
      }
    };
      ...
      function e(a) {
        for (var c = null, d = 1; d < m.length; d++)
          if (((c = (a + d + g.length) % g.length), g[c].hemisphere !== g[a].hemisphere)) {
            ...
            g[c].indexLabelText &&
            c !== a &&
            (0 > b(g[c], g[a]) || ("right" === g[a].hemisphere ? g[c].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y : g[c].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y))
          )
            break;
          else c = null;
        return c;
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          ...
          l &&
            ...
            (c = 0),
            (c = "right" === p.hemisphere ? z.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2))),
        ...
        for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          ...
          for (a = 0; a < m.length; a++)
            if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
              (u = u = 0),
                "right" === h.hemisphere
                  ? ((u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p)), (u *= -1))
                ...
                0 < u &&
                  ...
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < A || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) < A) &&
                ...
                0 < u &&
                  ...
                  Math.abs(h.indexLabelTextBlock.x - z.x) < A && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
    ...
    n.prototype.renderFunnel = function (a) {
      ...
      function b() {
        if (u && y) {
          for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], z = { percent: null, total: null }, C = null, A = 0; A < y.length; A++)
            (r = O[A]), (r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2), (r = g(r).x2 + 1), (B[A] = M - r - U);
          r = 0.5 * U;
          for (var A = 0, D = y.length - 1; A < y.length || 0 <= D; A++, D--) {
            ...
            "inside" === u.indexLabelPlacement &&
              ((B[A] = A !== ca ? (u.reversed ? O[A].x2 - O[A].x1 : O[A].x3 - O[A].x4) : O[A].x3 - O[A].x6),
              20 > B[A] && ((B[A] = A !== ca ? (u.reversed ? O[A].x3 - O[A].x4 : O[A].x2 - O[A].x1) : O[A].x2 - O[A].x1), (B[A] /= 2)));
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                ...
                !(l >= I.length - 1) &&
                  ...
                  (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1));
          }
      ...
      function g(a) {
        ...
        return b
          ? ((a = b.y6 ? (a > b.y6 ? b.x3 + ((b.x4 - b.x3) / (b.y4 - b.y3)) * (a - b.y3) : b.x2 + ((b.x3 - b.x2) / (b.y3 - b.y2)) * (a - b.y2)) : b.x2 + ((b.x3 - b.x2) / (b.y3 - b.y2)) * (a - b.y2)),
            { x1: a, x2: a })
          : -1;
      }
      function r(a) {
          ...
          if (-1 !== H) {
            ...
            if (!J)
              for (G = 0; G < y.length; G++)
                (A = u.dataPointIds[G]),
                  (a = { id: A, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[u.reversed ? y.length - 1 - G : G] }),
            ...
            if (!c.axisX.logarithmic)
              return Ba(
                ...
                d.xValueFormatString
                  ...
                  ? c.xValueFormatString
                  : (c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY"),
                f._cultureInfo
              );
    ...
    F.prototype.setLayout = function () {
        ...
        for (m = 0; m < n.length; m++) {
          ...
          if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
            if ("horizontal" === this.orientation) {
              ...
              null !== this.itemWidth &&
                (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)));
              if (
                !p ||
                p.width +
                  Math.round(
                    q.textBlock.width +
                      ...
                      ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)
                  ) >
                  f
              )
      ...
      "top" === this.verticalAlign
        ...
        : "bottom" === this.verticalAlign &&
          ((e = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2), (b = d.y2 - this.height));
      this.items = n;
    ...
    E.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (
            var c = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c;
            b < d;
            b += c
          )
        ...
        (h =
          this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
            ? (this.lineCoordinates.width *
                Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
              Math.log(this.range)
            : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) *
        ...
        (h =
          this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
            ? (this.lineCoordinates.height *
                Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
              Math.log(this.range)
            : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) *
              R[this.intervalType + "Duration"] *
              this.interval),
                    ...
                    if (s(this.options.labelWrap))
                      if (!s(this.options.labelMaxWidth))
                        ...
                        if (((b = (r.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                          ...
                          for (
                            this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0;
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                ...
                (a.angle = this.labelAngle =
                  s(this.options.labelAngle) ? (s(this.sessionVariables.labelAngle) ? (this.sessionVariables.labelAngle = this.labelAngle) : this.sessionVariables.labelAngle) : this.labelAngle),
                (a.wrap = this.labelWrap =
                  s(this.options.labelWrap) ? (s(this.sessionVariables.labelWrap) ? (this.sessionVariables.labelWrap = this.labelWrap) : this.sessionVariables.labelWrap) : this.options.labelWrap),
            ...
            for (c = 0; c < this._labels.length; c++)
              if (!this._labels[c].breaksLabelType) {
                ...
                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                  ...
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth =
                      0 === this.labelAngle ? f : Math.min((b - l * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)), l)),
                    s(this.options.labelWrap))
                  ? s(this.options.labelWrap) &&
                    (this.labelWrap && !s(this.options.labelMaxWidth)
                      ? ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth),
        ...
        if ("inside" != this.labelPlacement || ("inside" === this.labelPlacement && 0 < this._index))
          for (d = 0; d < this._labels.length; d++) {
            var b = this._labels[d].textBlock,
              ...
              f = 0,
              f =
                0 === this.labelAngle ? e.width : e.width * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle));
            a < f && (a = f);
      ...
      if ("bottom" === this._position || "top" === this._position) {
        ...
        for (c = 0; c < this._stripLineLabels.length; c++)
          "outside" === this._stripLineLabels[c].stripLine.labelPlacement &&
            ...
            (e = d.measureText()),
            (f =
              0 === this.labelAngle ? e.height : e.width * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))),
            a < f && (a = f),
    ...
    E.setLayout = function (a, d, c, b, e, f) {
        ...
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (var r = q[g].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[g].viewportMaximum); w++)
            r[w].endValue < q[g].viewportMinimum ||
              (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), r[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
      for (var v = (w = 0), u = 0, y = 0, z = 0, x = 0, D = 0, A, E, F = (h = 0), H, J, K, r = (H = J = K = !1), g = 0; g < q.length; g++)
        q[g] &&
          q[g].title &&
      ...
      if ("normal" === e) {
              ...
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (v =
                    ...
                    (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (u =
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ...
                    : 0 > a[g].labelAngle
                    ? A - v < l && A - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + x + A - v + a[g].labelFontSize / 2))
                    : 0 === a[g].labelAngle && (E + u > n && (h = E + u / 2 - n - $), A - v < l && A - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - x - A + v / 2)),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                ...
                (d[g].bounds = { x1: l, y1: h + (V + W - z[g] - S), x2: n, y2: k, width: n - l, height: k - h }),
                (S += z[g] + d[g].margin);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (L = m.isNavigator ? 0 : 10),
                c[g] &&
                  ...
                  (c[g].bounds = { x1: l - (x[g] + U), y1: h, x2: n, y2: k, width: n - l, height: k - h }),
              ...
              b[g] &&
                ...
                "inside" === b[g].labelPlacement &&
                  ...
                  ((b[g].lineCoordinates.x1 =
                    b[g].lineCoordinates.x1 + (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
        ...
        for (N = []; 4 > w; ) {
            ...
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                c[g].labelAutoFit &&
                  ...
                  0 < !d.length && (n = 0 < c[g].labelAngle ? n - z / 2 : 0 === c[g].labelAngle ? n - z / 2 : n)),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                ...
                b[g] && b[g].labelAutoFit && !s(x) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, x) : 0 === b[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (n -= D / 2)),
          ...
          E.push(p);
          if (b && 0 < b.length) for (A = [], g = S = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (S += A[g]), (Z += b[g].margin);
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++)
                  c[L] &&
                    c[L].labelAutoFit &&
                    ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l));
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++)
                  c[L] &&
                    c[L].labelAutoFit &&
                    ((n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l));
        ...
        if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
          ...
          this.stripLines[a].value = this.logarithmic
            ? this.stripLines[a].value *
              Math.sqrt(Math.log(Math.max(this.stripLines[a].startValue, this.stripLines[a].endValue) / Math.min(this.stripLines[a].startValue, this.stripLines[a].endValue)) / Math.log(d))
      ...
      for (
        var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width,
          ...
          c =
            ...
            a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum),
            ...
            for (k = 0; k < this._labels.length; k++)
              (p = this._labels[k]),
                p.position < this.viewportMinimum ||
                  ((l = p.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += l));
        ...
        if ("left" === this._position || "right" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            ...
            for (k = 0; k < this._labels.length; k++)
              (p = this._labels[k]),
                p.position < this.viewportMinimum ||
                  ((m = p.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += m));
                  ...
                  : ((q.x =
                      "inside" === this.labelPlacement
                        ? 0 < this.labelAngle
                          ...
                          : q.x - p.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                        : q.x +
                          (p.textBlock.height - this.labelFontSize) * Math.sin((Math.PI / 180) * this.labelAngle) -
              ...
              (d && 0 !== f++ % 2 && this.labelAutoFit) ||
                (0 === this.labelAngle
                  ? ((p.textBlock.y = q.y),
                    (p.textBlock.x =
                      "inside" === this.labelPlacement
                        ? q.x - p.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5
                  ...
                  ? ((m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
                    ...
                    0 === this.labelAngle
                      ...
                      : ((a.x +=
                        ...
                        (a.y -=
                          this.tickLength +
                          (c.textBlock.height * Math.cos((Math.PI / 180) * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) : 0)))))
                  : "left" === this._position
                  ...
                  : "right" === this._position &&
                    ...
                    0 === this.labelAngle
                      ...
                      : ((a.y = 0 > this.labelAngle ? a.y : a.y - (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.cos((Math.PI / 180) * this.labelAngle)),
                        (a.x =
                          0 < this.labelAngle
                            ? a.x + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) + this.tickLength
              ...
              if (d)
                if (e[c].startValue < this.conversionParameters.minimum) {
                  if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                    ...
                    (a *=
                      e[c].endValue / this.conversionParameters.minimum / Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue))),
                ...
                if (e[c].endValue > this.conversionParameters.minimum) {
                  if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) {
                    ...
                    (a *=
                      ...
                      Math.pow(e[c].size, Math.log(e[c].startValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)) *
                      b),
          ...
          "axisY" === this.type &&
            ...
            isFinite(e) || isFinite(f)
              ? isFinite(e)
                ? isFinite(f) || (f = e)
                : (e = f)
              : ((f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval),
        ...
        if ("axisX" === this.type && c) {
          this.intervalType ||
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration)),
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = E.getNiceExponent(Math.log(h) / d / (a - 1), !0)), (c = E.getNiceNumber(n / (a - 1), !0)));
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          ...
          ((this.interval = E.getNiceExponent(Math.ceil(Math.log(h) / d) / (a - 1))), (c = E.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        "axisX" === this.type
      ...
      if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
        ...
        this.options.interval ||
          ...
          this.range > this.interval && ((this.interval = c), (b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval)))),
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
            ...
            for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = (u = 0), r = (x = 0); r < m.length; r++)
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
              ...
              v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
              z = u = 0;
              for (r = x; 0 <= r; r--) (z += m[r].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(z))), u < v && ((v = u), (b = r));
          ...
          "bottom" === this.parent._position
            ...
            : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2);
        } else if ("left" === this.parent._position || "right" === this.parent._position) {
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize / 2),
            "bottom" === this.parent._position &&
              this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 &&
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (b = e.dataPoints[this.currentDataPointIndex]),
                ...
                "waterfall" === e.type &&
                  ((k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue), (k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum));
            else {
              if (
                !this.enabled ||
                ("line" !== e.type &&
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            if (null !== c) {
              ...
              if (this.isToolTipDefinedInData && s(this.options.content) && s(this.options.contentFormatter))
                for (h = this.contentDiv.getElementsByTagName("span"), b = 0, v = this.reversed ? f.length - 1 : 0; b < f.length, this.reversed ? 0 <= v : v < f.length; b++, this.reversed ? v-- : v++)
                  h[b] && (h[b].style.color = this.chart.replaceKeywordsWithValue("{color}", f[v].dataPoint, f[v].dataSeries, f[v].index));
              h = !1;
      ...
      if (this.isToolTipDefinedInData && ((this.content && "function" === typeof this.content) || this.contentFormatter))
        ...
        "waterfall" === c.type
          ...
          ? (f = b.toolTipContent
              ...
              : this.content && "function" !== typeof this.content
              ? this.content
              : "<span>" + (b.name ? "{name}:</span>&nbsp;&nbsp;" : b.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}")
          : "rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type || "error" === c.type
          ? (f = b.toolTipContent
              ? b.toolTipContent
              : c.toolTipContent
              ...
              : this.content && "function" !== typeof this.content
              ? this.content
              : "<span>" + (b.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}")
          : "candlestick" === c.type || "ohlc" === c.type
          ? (f = b.toolTipContent
              ? b.toolTipContent
              : c.toolTipContent
    ...
    W.prototype.showAtX = function (a, d) {
      ...
      if (0 < f.length) {
        ...
        if (null !== h) {
          ...
          if (this.isToolTipDefinedInData && s(this.options.content) && s(this.options.contentFormatter))
            for (b = this.contentDiv.getElementsByTagName("span"), h = 0, e = this.reversed ? f.length - 1 : 0; h < f.length, this.reversed ? 0 <= e : e < f.length; h++, this.reversed ? e-- : e++)
              b[h] && (b[h].style.color = this.chart.replaceKeywordsWithValue("{color}", f[e].dataPoint, f[e].dataSeries, f[e].index));
          h = !1;
          "none" === this.container.style.display && ((h = !0), (this.container.style.display = "block"));
          try {
            (this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : w ? "rgba(255,255,255,.9)" : "rgb(255,255,255)"),
          ...
          c + this.container.clientWidth > Math.max(this.chart.container.clientWidth, this.chart.width) &&
    ...
    ga.prototype.fireEvent = function (a, d, c) {
      if (a && d) {
        ...
        "mouseout" !== d
          ...
          : ((c.target.style.cursor = this.chart._defaultCursor), delete a.eventParameter, delete a.eventContext);
  ...
  (function () {
    ...
    function O(a) {
      ...
      a.styleSheets.ex_canvas_ ||
        ((a = a.createStyleSheet()), (a.owningElement.id = "ex_canvas_"), (a.cssText = "canvas{display:inline-block;overflow:hidden;text-align:left;width:300px;height:150px}"));
    }
    function X(a) {
      var b = a.srcElement;
